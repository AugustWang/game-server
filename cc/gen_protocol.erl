...
main(_) ->
    SrcDir = "",
    PackTxt = SrcDir ++ "src/pack.txt",
    PackErl = SrcDir ++ "src/pack.erl",
    PackMod = "pack",
    UnPackTxt = SrcDir ++ "src/unpack.txt",
    UnPackErl = SrcDir ++ "src/unpack.erl",
    UnPackMod = "unpack",
...
",
    ...
    io:format("~nGenerate ~s ok!", [TargetPath]),
